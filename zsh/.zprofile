...
if [[ "$THEME" == 'lite' ]]; then
    export FZF_DEFAULT_OPTS="$FZF_DEFAULT_OPTS --color=bg+:#CEE1F8,fg:#000000,spinner:#8250DF,hl:#8250DF \
--color=header:#8250DF,info:#9A6700,pointer:#8250DF \
--color=marker:#1A7F37,fg+:#000000,bg:#F6F8FA,prompt:#9A6700,pointer:#1A7F37,hl+:#8250DF"
