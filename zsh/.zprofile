...
if [ "$THEME" = "gruvbox" ]; then
  export FZF_DEFAULT_OPTS="$FZF_DEFAULT_OPTS --color=fg:#ebdbb2,bg:#282828,hl:#fabd2f --color=fg+:#ebdbb2,bg+:#3c3836,hl+:#fabd2f --color=info:#83a598,prompt:#b8bb26,pointer:#ebdbb2,marker:#83a598,spinner:#d3869b"
fi
